...
(defun taz_polaczenie_zakladkowe_widok ( / *error* )
  ...
  (action_tile
    "cancel"
    "(setq taz_polaczenie_parametr_s nil)
    (setq taz_polaczenie_parametr_p nil)
    (setq taz_polaczenie_parametr_e nil)
	(setq taz_polaczenie_zakladkowe_ilosc_srub_w_poziomie nil)
	(setq taz_polaczenie_zakladkowe_ilosc_srub_w_pionie nil)
    (done_dialog)"
  )
  (action_tile
    "accept"
  ...
  (taz_polaczenie_zakladkowe_widok_schemat "taz_polaczenie_zakladkowe_widok_schemat_key")
	...
	(if (or (equal taz_polaczenie_zakladkowe_ilosc_srub_w_poziomie "0") (equal taz_polaczenie_zakladkowe_ilosc_srub_w_poziomie ""))
		(progn
			(alert "Niepoprawna ilosc srub")
			(*error*)
		)
		(princ)
	)
	
	(if (or (equal taz_polaczenie_zakladkowe_ilosc_srub_w_pionie "0") (equal taz_polaczenie_zakladkowe_ilosc_srub_w_pionie ""))
		(progn
			(alert "Niepoprawna ilosc srub")
			(*error*)
		)
  ...
  (if (or (equal taz_polaczenie_zakladkowe_ilosc_srub_w_poziomie nil) (equal taz_polaczenie_zakladkowe_ilosc_srub_w_pionie nil))
	(progn
			(*error*)
	)
	(princ)
